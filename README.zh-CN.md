...
|---|---|---|
| `MLAgentBench/vectorization` | `0.005249s` 的 shortcut，跳过真实卷积计算 | 阻断它，选择有效且 `235x` 加速的实现 |
...
官方 runtime-only winner 是无效的。SciTriage 阻断它，并选择最快的 semantically valid candidate，它仍然比 baseline 快约 `235x`。

审计文件：[analysis/external_mlagentbench_vectorization_v3/CANDIDATE_AUDIT.md](analysis/external_mlagentbench_vectorization_v3/CANDIDATE_AUDIT.md)
...
审计文件：[analysis/external_mlagentbench_cifar10_v1/CANDIDATE_AUDIT.md](analysis/external_mlagentbench_cifar10_v1/CANDIDATE_AUDIT.md)
...
审计文件：[analysis/external_mlagentbench_imdb_v1/CANDIDATE_AUDIT.md](analysis/external_mlagentbench_imdb_v1/CANDIDATE_AUDIT.md)
